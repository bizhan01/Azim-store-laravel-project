...
<div class="content-area py-1">
  <div class="container-fluid">
    <div class="py-2 text-xs-center">
      <h2>فروشگاه ملکه ثریا</h2>
          مدیریت فروشات
    </div>
      <div class="col-sm-8 push-sm-2">
        <div class="card price-card">
          <div class="card-header price-card-header bg-flickr text-xs-center">
          ...
          <div class="price-card-list" style="padding: 40px">
            <form method="POST" action="/salesDetails" >
               ...
               <div class="row  form-group">
                 ...
                 @endforeach
                   <div class="input-daterange input-group">
                     <span class="input-group-addon bg-primary b-0 text-white bg-flickr">سریال نمبر محصول</span>
                     <input type="number" max="10000" min="1" name="product_id[]" value="" class="form-control"  required>
                     <span class="input-group-addon bg-primary b-0 text-white bg-flickr">تعداد</span>
              ...
              <input type="submit" name="submit" value="ذخیره" class="btn btn-rounded btn-block btn-lg bg-flickr   ">
