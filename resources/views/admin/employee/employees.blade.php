                ...
                <tbody>
                  @foreach($employees as $employee)
                   <tr>
                     ...
                     <td>{{$employee->dob}}</td>
                     <td style="direction: ltr">{{$employee->phone1}}</td>
                     <td style="direction: ltr">{{$employee->phone2}}</td>
                     ...
                     <td>
                       <a href="{{ URL::to('employees/' . $employee->id . '/edit') }}"> <input type="button"  value="ویرایش" class="btn btn-rounded btn-info"> </a>
                      </td>
                      <td>
